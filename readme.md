...
```
docker container run -p 8080:8080 --link=mysql -e RDS_HOSTNAME=mysql  atingupta2005/todo-web-application-mysql:0.0.1-SNAPSHOT
```
...
```
Rangas-MacBook-Air:projects atingupta2005$ mysqlsh
MySQL Shell 8.0.15
